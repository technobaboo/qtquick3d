...
public:
    ...
    virtual void setDrawParameters(QDemonRenderDrawMode::Enum drawMode, QDemonRenderWinding::Enum winding) = 0;
    ...
    virtual void addMeshSubset(const char16_t *inSubsetName, quint32 count, quint32 offset, const QDemonBounds3 &inBounds) = 0;
