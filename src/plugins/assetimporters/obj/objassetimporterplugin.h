...
class ObjAssetImporterPlugin : public QDemonAssetImporterPlugin
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID QDemonAssetImporterFactoryInterface_iid FILE "obj.json")
public:
...
#endif // OBJASSETIMPORTERPLUGIN_H
