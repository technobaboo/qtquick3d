...
public:
    /**
         ...
         * @return No return.
         */
    QDemonRenderComputeShader(const QDemonRef<QDemonRenderContextImpl> &context,
    ...
    /**
         ...
         */
    virtual QDemonRenderBackend::QDemonRenderBackendComputeShaderObject getShaderHandle()
    {
