...
#ifndef QSSG_RENDER_TEXTURE_2D_ARRAY_H
#define QSSG_RENDER_TEXTURE_2D_ARRAY_H
...
class Q_QUICK3DRENDER_EXPORT QSSGRenderTexture2DArray : public QSSGRenderTextureBase
{
    Q_DISABLE_COPY(QSSGRenderTexture2DArray)
private:
...
public:
     ...
     * @return No return.
     */
    QSSGRenderTexture2DArray(const QSSGRef<QSSGRenderContext> &context);

    virtual ~QSSGRenderTexture2DArray();
