...
#ifndef QSSG_RENDER_DRAW_INDIRECT_BUFFER_H
#define QSSG_RENDER_DRAW_INDIRECT_BUFFER_H
...
class Q_QUICK3DRENDER_EXPORT QSSGRenderDrawIndirectBuffer : public QSSGRenderDataBuffer
{
public:
    /**
     * @brief constructor
     ...
     * @return No return.
     */
    QSSGRenderDrawIndirectBuffer(const QSSGRef<QSSGRenderContext> &context,
                                   QSSGRenderBufferUsageType usageType,
                                   QSSGByteView data);

    ///< destructor
    virtual ~QSSGRenderDrawIndirectBuffer();
