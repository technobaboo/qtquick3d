...
class QDemonRenderGeometryShader : public QDemonRenderShader
{
...
public:
     ...
     * @return No return.
     */
    QDemonRenderGeometryShader(const QDemonRef<QDemonRenderContext> &context, QDemonConstDataRef<qint8> source, bool binaryProgram);
