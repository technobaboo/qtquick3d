...
bool QDemonRenderBackendGLES2Impl::unmapBuffer(QDemonRenderBackendBufferObject, QDemonRenderBufferType bindFlags)
{
    GLboolean ret;
...
QDemonRenderBackend::QDemonRenderBackendQueryObject QDemonRenderBackendGLES2Impl::createQuery()
{
    ...
    return reinterpret_cast<QDemonRenderBackendQueryObject>(glQueryID);
}
