                                                                                             ...
                                                                                             QSSGByteView hostData)
{
    ...
    return reinterpret_cast<QSSGRenderBackend::QSSGRenderBackendBufferObject>(bufID);
}
...
QSSGRenderBackend::QSSGRenderBackendRenderTargetObject QSSGRenderBackendGLBase::createRenderTarget()
{
    ...
    return reinterpret_cast<QSSGRenderBackend::QSSGRenderBackendRenderTargetObject>(fboID);
}
                                                                                                         ...
                                                                                                         qint32 height)
{
    ...
    return reinterpret_cast<QSSGRenderBackend::QSSGRenderBackendRenderbufferObject>(bufID);
}
...
QSSGRenderBackend::QSSGRenderBackendTextureObject QSSGRenderBackendGLBase::createTexture()
{
    ...
    return reinterpret_cast<QSSGRenderBackend::QSSGRenderBackendTextureObject>(texID);
}
                                                                                                         ...
                                                                                                         bool binary)
{
    ...
    return reinterpret_cast<QSSGRenderBackend::QSSGRenderBackendVertexShaderObject>(shaderID);
}
                                                                                                             ...
                                                                                                             bool binary)
{
    ...
    return reinterpret_cast<QSSGRenderBackend::QSSGRenderBackendFragmentShaderObject>(shaderID);
}
