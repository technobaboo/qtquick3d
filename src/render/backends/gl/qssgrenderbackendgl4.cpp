        ...
        bool binary)
{
    ...
    return reinterpret_cast<QSSGRenderBackend::QSSGRenderBackendTessControlShaderObject>(shaderID);
}
        ...
        bool binary)
{
    ...
    return reinterpret_cast<QSSGRenderBackend::QSSGRenderBackendTessEvaluationShaderObject>(shaderID);
}
                                                                                                              ...
                                                                                                              bool binary)
{
    ...
    return reinterpret_cast<QSSGRenderBackend::QSSGRenderBackendGeometryShaderObject>(shaderID);
}
...
#endif
    return reinterpret_cast<QSSGRenderBackend::QSSGRenderBackendComputeShaderObject>(shaderID);
}
...
QSSGRenderBackend::QSSGRenderBackendProgramPipeline QSSGRenderBackendGL4Impl::createProgramPipeline()
{
    ...
    return reinterpret_cast<QSSGRenderBackend::QSSGRenderBackendProgramPipeline>(pipeline);
}
...
QSSGRenderBackend::QSSGRenderBackendPathObject QSSGRenderBackendGL4Impl::createPathNVObject(size_t range)
{
    ...
    return reinterpret_cast<QSSGRenderBackend::QSSGRenderBackendPathObject>(pathID);
}
        ...
        quint32 *count)
{
    ...
    return reinterpret_cast<QSSGRenderBackend::QSSGRenderBackendPathObject>(baseAndCount[0]);
}
