    ...
    : QDemonRenderBackendGL3Impl(format)
{
    ...
    for (qint32 i = 0; i < numExtensions; i++) {
        ...
        if (!m_backendSupport.caps.bits.bTessellationSupported && QDemonGlExtStrings::extTess().compare(extensionString) == 0) {
            m_backendSupport.caps.bits.bTessellationSupported = true;
        } else if (!m_backendSupport.caps.bits.bComputeSupported && QDemonGlExtStrings::arbCompute().compare(extensionString) == 0) {
...
void QDemonRenderBackendGL4Impl::setPatchVertexCount(QDemonRenderBackendInputAssemblerObject iao, quint32 count)
{
    Q_ASSERT(iao);
    Q_ASSERT(count);
...
void QDemonRenderBackendGL4Impl::bindImageTexture(QDemonRenderBackendTextureObject to,
                                                  quint32 unit,
                                                  qint32 level,
                                                  bool layered,
                                                  qint32 layer,
...
qint32 QDemonRenderBackendGL4Impl::getStorageBufferInfoByID(QDemonRenderBackendShaderProgramObject po,
                                                            quint32 id,
                                                            quint32 nameBufSize,
                                                            qint32 *paramCount,
                                                            qint32 *bufferSize,
...
void QDemonRenderBackendGL4Impl::programSetStorageBuffer(quint32 index, QDemonRenderBackendBufferObject bo)
{
#if defined(GL_VERSION_4_3) || defined(QT_OPENGL_ES_3_1)
...
qint32 QDemonRenderBackendGL4Impl::getAtomicCounterBufferInfoByID(QDemonRenderBackendShaderProgramObject po,
                                                                  quint32 id,
                                                                  quint32 nameBufSize,
                                                                  qint32 *paramCount,
                                                                  qint32 *bufferSize,
...
void QDemonRenderBackendGL4Impl::programSetAtomicCounterBuffer(quint32 index, QDemonRenderBackendBufferObject bo)
{
#if defined(GL_VERSION_4_3) || defined(QT_OPENGL_ES_3_1)
...
void QDemonRenderBackendGL4Impl::dispatchCompute(QDemonRenderBackendShaderProgramObject, quint32 numGroupsX, quint32 numGroupsY, quint32 numGroupsZ)
{
...
QDemonRenderBackend::QDemonRenderBackendPathObject QDemonRenderBackendGL4Impl::createPathNVObject(size_t range)
{
...
QDemonBounds3 QDemonRenderBackendGL4Impl::getPathObjectBoundingBox(QDemonRenderBackendPathObject inPathObject)
{
    float data[4];
#if defined(GL_NV_path_rendering)
    GL_CALL_NVPATH_EXT(glGetPathParameterfvNV(HandleToID_cast(GLuint, size_t, inPathObject), GL_PATH_OBJECT_BOUNDING_BOX_NV, data));
#endif
...
QDemonBounds3 QDemonRenderBackendGL4Impl::getPathObjectFillBox(QDemonRenderBackendPathObject inPathObject)
{
    float data[4];
#if defined(GL_NV_path_rendering)
    GL_CALL_NVPATH_EXT(glGetPathParameterfvNV(HandleToID_cast(GLuint, size_t, inPathObject), GL_PATH_FILL_BOUNDING_BOX_NV, data));
#endif
    return QDemonBounds3(QVector3D(data[0], data[1], 0.0f), QVector3D(data[2], data[3], 0.0f));
}
...
QDemonBounds3 QDemonRenderBackendGL4Impl::getPathObjectStrokeBox(QDemonRenderBackendPathObject inPathObject)
{
    float data[4];
#if defined(GL_NV_path_rendering)
    GL_CALL_NVPATH_EXT(glGetPathParameterfvNV(HandleToID_cast(GLuint, size_t, inPathObject), GL_PATH_STROKE_BOUNDING_BOX_NV, data));
#endif
    return QDemonBounds3(QVector3D(data[0], data[1], 0.0f), QVector3D(data[2], data[3], 0.0f));
}

void QDemonRenderBackendGL4Impl::setStrokeWidth(QDemonRenderBackendPathObject inPathObject, float inStrokeWidth)
{
#if defined(GL_NV_path_rendering)
    GL_CALL_NVPATH_EXT(glPathParameterfNV(HandleToID_cast(GLuint, size_t, inPathObject), GL_PATH_STROKE_WIDTH_NV, inStrokeWidth));
#endif
}
...
void QDemonRenderBackendGL4Impl::getPathMetricsRange(QDemonRenderBackendPathObject po,
                                                     size_t numPaths,
                                                     QDemonRenderPathGlyphFontMetricFlags metricQueryMask,
                                                     size_t stride,
                                                     float *metrics)
