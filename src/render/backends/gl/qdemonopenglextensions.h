...
inline GLenum QDemonOpenGLExtensions::glPathGlyphIndexArrayNV(GLuint firstPathName,
                                                              GLenum fontTarget,
                                                              const void *fontName,
                                                              GLbitfield fontStyle,
                                                              GLuint firstGlyphIndex,
...
inline void QDemonOpenGLES2Extensions::glPatchParameteriEXT(GLenum pname, GLint value)
{
    Q_D(QDemonOpenGLExtensions);
    d->PatchParameteriEXT(pname, value);
}

inline void QDemonOpenGLES2Extensions::glQueryCounterEXT(GLuint id, GLenum target)
{
    Q_D(QDemonOpenGLExtensions);
    d->QueryCounterEXT(id, target);
}

inline void QDemonOpenGLES2Extensions::glGetQueryObjectui64vEXT(GLuint id, GLenum pname, GLuint64 *params)
{
    Q_D(QDemonOpenGLExtensions);
...
inline void QDemonOpenGLES2Extensions::glDeletePathsNV(GLuint path, GLsizei range)
{
    Q_D(QDemonOpenGLExtensions);
...
inline void QDemonOpenGLES2Extensions::glPathParameterfNV(GLuint path, GLenum pname, GLfloat value)
{
    Q_D(QDemonOpenGLExtensions);
    d->PathParameterfNV(path, pname, value);
}

inline void QDemonOpenGLES2Extensions::glPathStencilDepthOffsetNV(GLfloat factor, GLfloat units)
{
    Q_D(QDemonOpenGLExtensions);
    d->PathStencilDepthOffsetNV(factor, units);
}

inline void QDemonOpenGLES2Extensions::glStencilFillPathNV(GLuint path, GLenum fillMode, GLuint mask)
{
    Q_D(QDemonOpenGLExtensions);
    d->StencilFillPathNV(path, fillMode, mask);
}

inline void QDemonOpenGLES2Extensions::glStencilStrokePathNV(GLuint path, GLint reference, GLuint mask)
{
    Q_D(QDemonOpenGLExtensions);
    d->StencilStrokePathNV(path, reference, mask);
}

inline void QDemonOpenGLES2Extensions::glStencilFillPathInstancedNV(GLsizei numPaths,
                                                                    GLenum pathNameType,
                                                                    const void *paths,
                                                                    GLuint pathBase,
                                                                    GLenum fillMode,
...
inline void QDemonOpenGLES2Extensions::glStencilStrokePathInstancedNV(GLsizei numPaths,
                                                                      GLenum pathNameType,
                                                                      const void *paths,
                                                                      GLuint pathBase,
                                                                      GLint reference,
...
inline void QDemonOpenGLES2Extensions::glCoverFillPathInstancedNV(GLsizei numPaths,
                                                                  GLenum pathNameType,
                                                                  const void *paths,
                                                                  GLuint pathBase,
                                                                  GLenum coverMode,
...
inline void QDemonOpenGLES2Extensions::glCoverStrokePathInstancedNV(GLsizei numPaths,
                                                                    GLenum pathNameType,
                                                                    const void *paths,
                                                                    GLuint pathBase,
                                                                    GLenum coverMode,
...
inline void QDemonOpenGLES2Extensions::glGetPathParameterfvNV(GLuint path, GLenum pname, GLfloat *value)
{
    Q_D(QDemonOpenGLExtensions);
    d->GetPathParameterfvNV(path, pname, value);
}

inline void QDemonOpenGLES2Extensions::glGetPathMetricsNV(GLbitfield metricQueryMask,
                                                          GLsizei numPaths,
                                                          GLenum pathNameType,
                                                          const void *paths,
                                                          GLuint pathBase,
...
inline void QDemonOpenGLES2Extensions::glGetPathMetricRangeNV(GLbitfield metricQueryMask,
