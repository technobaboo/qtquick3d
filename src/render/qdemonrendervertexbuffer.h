...
public:
    /**
         ...
         * @return No return.
         */
    QDemonRenderVertexBuffer(const QSharedPointer<QDemonRenderContextImpl> &context,
                             size_t size,
                             quint32 stride,
    ...
    static QSharedPointer<QDemonRenderVertexBuffer> create(const QSharedPointer<QDemonRenderContextImpl> &context,
