...
{
    QSSGGTypes type;
    constexpr QSSGPGGraphObject(QSSGGTypes inType) : type(inType) {}
};
...
struct QSSGPGRect : public QSSGPGGraphObject
{
    ...
    constexpr QSSGPGRect() : QSSGPGGraphObject(QSSGGTypes::Rect) {}
};
...
struct QSSGPGVertLine : public QSSGPGGraphObject
{
    ...
    constexpr QSSGPGVertLine() : QSSGPGGraphObject(QSSGGTypes::VertLine) {}
};
...
struct QSSGPGHorzLine : public QSSGPGGraphObject
{
    ...
    constexpr QSSGPGHorzLine() : QSSGPGGraphObject(QSSGGTypes::HorzLine) {}
};
QT_END_NAMESPACE
