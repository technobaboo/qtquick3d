...
QDemonRenderShaderProgram *Qt3DSRendererImpl::GenerateShader(SSubsetRenderable &inRenderable,
...
QDemonRenderShaderProgram *Qt3DSRendererImpl::GetTextAtlasEntryShader()
{
    GetProgramGenerator().BeginProgram();
