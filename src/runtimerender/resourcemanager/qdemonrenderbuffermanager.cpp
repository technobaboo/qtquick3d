...
//                QDemonRenderAttribLayout *theAttribLayout = m_Context->CreateAttributeLayout(toConstDataRef(theEntryBuffer.constData(), theEntryBuffer.count());
...
//        }
    ...
    SRenderMesh *CreateMesh(const char *inSourcePath, quint8 *inVertData, quint32 inNumVerts,
                            ...
                            QDemonBounds3 inBounds) override
    {
        ...
        if (theMesh.second == true) {
            ...
            */
            ...
            QString fullName(QString::fromLocal8Bit(inSourcePath));
            QString subName(QString::fromLocal8Bit(inSourcePath));
