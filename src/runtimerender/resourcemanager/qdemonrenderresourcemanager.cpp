...
QDemonResourceManager::QDemonResourceManager(const QDemonRef<QDemonRenderContext> &ctx)
    : renderContext(ctx)
{
}

QDemonResourceManager::~QDemonResourceManager() = default;

QDemonRef<QDemonRenderFrameBuffer> QDemonResourceManager::allocateFrameBuffer()
{
...
void QDemonResourceManager::release(QDemonRef<QDemonRenderFrameBuffer> inBuffer)
{
...
QDemonRef<QDemonRenderRenderBuffer> QDemonResourceManager::allocateRenderBuffer(qint32 inWidth, qint32 inHeight, QDemonRenderRenderBufferFormat inBufferFormat)
{
...
void QDemonResourceManager::release(QDemonRef<QDemonRenderRenderBuffer> inBuffer)
{
    freeRenderBuffers.push_back(inBuffer);
}

QDemonRef<QDemonRenderTexture2D> QDemonResourceManager::setupAllocatedTexture(QDemonRef<QDemonRenderTexture2D> inTexture)
{
...
QDemonRef<QDemonRenderTexture2D> QDemonResourceManager::allocateTexture2D(qint32 inWidth, qint32 inHeight, QDemonRenderTextureFormat inTextureFormat, qint32 inSampleCount, bool immutable)
{
...
void QDemonResourceManager::release(QDemonRef<QDemonRenderTexture2D> inBuffer)
{
#ifdef _DEBUG
...
QDemonRef<QDemonRenderTexture2DArray> QDemonResourceManager::allocateTexture2DArray(qint32 inWidth, qint32 inHeight, qint32 inSlices, QDemonRenderTextureFormat inTextureFormat, qint32 inSampleCount)
{
    ...
    if (!freeTexArrays.empty() && !inMultisample) {
        ...
        // note we could re-use a former MSAA texture
        // this causes a entiere destroy of the previous texture object
        theTexture->setTextureData(QDemonByteView(), 0, inWidth, inHeight, inSlices, inTextureFormat);
        theTexture->setMinFilter(QDemonRenderTextureMinifyingOp::Linear);
        theTexture->setMagFilter(QDemonRenderTextureMagnifyingOp::Linear);
        return theTexture;
    }
...
void QDemonResourceManager::release(QDemonRef<QDemonRenderTexture2DArray> inBuffer)
{
#ifdef _DEBUG
...
QDemonRef<QDemonRenderTextureCube> QDemonResourceManager::allocateTextureCube(qint32 inWidth, qint32 inHeight, QDemonRenderTextureFormat inTextureFormat, qint32 inSampleCount)
{
    bool inMultisample = inSampleCount > 1 && renderContext->supportsMultisampleTextures();
    ...
    if (!freeTexCubes.empty() && !inMultisample) {
        ...
        theTexture->setTextureData(QDemonByteView(), 0, QDemonRenderTextureCubeFace::CubePosX, inWidth, inHeight, inTextureFormat);
        theTexture->setTextureData(QDemonByteView(), 0, QDemonRenderTextureCubeFace::CubeNegX, inWidth, inHeight, inTextureFormat);
        theTexture->setTextureData(QDemonByteView(), 0, QDemonRenderTextureCubeFace::CubePosY, inWidth, inHeight, inTextureFormat);
        theTexture->setTextureData(QDemonByteView(), 0, QDemonRenderTextureCubeFace::CubeNegY, inWidth, inHeight, inTextureFormat);
        theTexture->setTextureData(QDemonByteView(), 0, QDemonRenderTextureCubeFace::CubePosZ, inWidth, inHeight, inTextureFormat);
        theTexture->setTextureData(QDemonByteView(), 0, QDemonRenderTextureCubeFace::CubeNegZ, inWidth, inHeight, inTextureFormat);
        theTexture->setMinFilter(QDemonRenderTextureMinifyingOp::Linear);
        theTexture->setMagFilter(QDemonRenderTextureMagnifyingOp::Linear);
        return theTexture;
    }
...
void QDemonResourceManager::release(QDemonRef<QDemonRenderTextureCube> inBuffer)
{
#ifdef _DEBUG
...
QDemonRef<QDemonRenderImage2D> QDemonResourceManager::allocateImage2D(QDemonRef<QDemonRenderTexture2D> inTexture, QDemonRenderImageAccessType inAccess)
{
...
void QDemonResourceManager::release(QDemonRef<QDemonRenderImage2D> inBuffer)
{
#ifdef _DEBUG
...
QDemonRef<QDemonRenderContext> QDemonResourceManager::getRenderContext() { return renderContext; }

void QDemonResourceManager::destroyFreeSizedResources()
{
